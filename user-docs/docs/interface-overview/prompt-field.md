...
![Vue générale du champ de saisie de prompt](/img/screenshot-prompt-text-area.png)
...
* **Support multi-lignes :** Si votre question est longue, le champ de texte s'agrandira automatiquement pour accommoder plusieurs lignes de texte.
    ...
    ![Zone de texte du prompt avec exemple de question en arabe](/img/screenshot-prompt-field-overview.png) 
...
* **Fonction :** Une fois que vous avez tapé votre question, cliquez sur ce bouton pour l'envoyer à l'IA.

    ![Bouton Envoyer à côté du champ de prompt](/img/screenshot-prompt-send-button.png)
...
### 3. Indicateur de Chargement lors de l'Envoi
...
Maintenant que vous savez comment poser des questions, découvrons [La Zone de Gestion des Documents](./document-management-pane.md) où vous gérerez la sélection des documents pour vos conversations.